...
with a non-conformal meshing strategy described in \cite{zhang-thermal-2014}. In the case that
...
\changed{The simulator is significantly underestimating both the number of wiring tiers
...
Power delivery in 3DICs becomes challenging, as a high performance 3DIC may have a significantly
...
The number of power connections to each tier required for stable operation is primarily determined by the maximum power draw and power density 
of the system,
...
While the total power dissipation of an IC is expected to decrease as the systemis partitioned into increasing numbers of layers 
...
\changed{In all cases, the microfluidically-cooled cores run faster than their air-cooled counterparts.}
