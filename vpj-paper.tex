...
\changed{While the worst-case error in these benchmarks is relatively high ($27.8\%$), 
the typical error is much lower.
...
Overall, this level of accuracy is sufficient for the investigation
