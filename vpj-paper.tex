...
\title{\changed{Investigation of Power, Signal, and Thermal Performance of 3DICs Using a Virtual Integration Platform}}
...
has a heat transfer coefficient of $4.63$ W/cm$^2$K, as reported in \cite{zhang-micropinfin-heat-sink-2013}.}
...
As can be seen in \cref{f-sb3d-freq-vs-tiers}, the maximum frequency decreases rapidly as the CPU is folded across
more and more tiers, as the increased power density of the system increases the strain on the cooling system.
Microfluidic cooling can significantly increase the performance of both 2D and 3DICs.
...
\begin{figure}[!htbp]
	...
	\caption{
		Maximum frequency achievable by 2D and 3D a 32nm Sandy Bridge CPU cores limited to 90$^\circ$C under air cooling (blue)
