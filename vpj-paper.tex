...
\changed{
In order to model the on-chip interconnect properties, the system is treated as a homogeneous logic block.
...
capacitance can significantly reduce the number of power pads or TSVs, but integrating high decoupling capacitance densities could be challenging. 
