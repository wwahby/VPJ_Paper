...
two parameters which describe the degree of interconnection in the design (described in more detail in \cref{s-interconnect-modeling}).
These parameters are used to first generate an estimate for the number of TSVs required for signal routing, if the design
is to be implemented in 3D. The TSV size and number are then used by the interconnect module to estimate the distribution of 
