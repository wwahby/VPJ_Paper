...
\title{\changed{Compact Modeling of Trends in 3DIC Power, Signal, and Thermal Performance}}
...
in the system. In this case, the interconnect networks and power consumption of each block are modeled separately, and then assemble an overall power density map of each tier in the design
...
Currently, the interconnections between logic blocks are not modeled when simulating heterogeneous 3D stacks. In order to better predict the
...
more and more tiers, as the increased power density (\cref{f-sb-power-vs-tiers-ild}) of the 3D 
...
at advanced process nodes. \changed{The results suggest that 3D implementations of 2D systems should exhibit greater energy efficiency
