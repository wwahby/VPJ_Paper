...
which relate the number of terminals leaving a logic block, $T$,
to the number of logic gates contained within that block, $N$, by the expression $T=kN^p$ \cite{landman_pinblock_1971,christie_interpretation_2000}.
}

\changed{The Rent relation can be used to determine the number of TSVs required for routing signals within a 3DIC. 
