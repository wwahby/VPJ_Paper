...
additional knowledge of the design. Similarly, off-chip interconnects are ignored when simulating both homogeneous
...
are related by the power law expression
\begin{align}
	T &= kN^p
\end{align}
...
\begin{figure}[tb]
	\centering
	\includegraphics[width=2.0in]{Figures/thermal_config_no_bc_2.png}
	\caption{
