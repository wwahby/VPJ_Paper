...
if the demand for TSVs outstrips available area, the TSV diameter is reduced and the interconnect and power modules are rerun.}
...
constraint and the thermal constraint the final design parameters are reported.}
...
Both 2D and 3D systems benefit from the development of ULK interlayer dielectric materials, and 
