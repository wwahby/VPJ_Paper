...
\begin{figure}[tb]
	\centering
	\includegraphics[width=2.75in]{Figures/vp-flowchart-3.png}
...
The method was extended to consider 3DICs in 
\cite{rahman_wire-length_1999-1,joyner_three-dimensional_2000, joyner_impact_2001},
but the impact of TSV-induced gate-blockage was not considered until \cite{kim_through-silicon-via_2009-1}
...
\begin{figure}[tb]
	\centering
	\includegraphics[width=2.75in]{Figures/thermal_fd_setup.png}
	\caption{
