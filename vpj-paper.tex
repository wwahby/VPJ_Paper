...
the GPU is simulated with a Rent exponent of $0.5$.
In each case, the pitch and number of metal layers required for routing was set by the block which required
the greatest number of wiring tiers (typically the CPU core).
The 45nm and 32nm test cases all have a total of 9 metal levels. In these cases the upper wiring tier has very
