...
\title{\changed{3DVP: A CAD Tool for Rapid Simulation of Trends in 3DIC Performance and Power Consumption}}
...
no analog exists for 3DICs. Additionally, the 2D tools do not model power delivery or heat extraction, 
...
properties of 3DIC on-chip signal and power delivery networks while properly accounting for the impact of TSV area.
...
\changed{This paper first presents the modeling details, followed by validation and predictions. 
...
technologies on a 32nm Sandy Bridge i7 processing core in \cref{s-2d-investigations,s-3d-investigations}.
Specifically, the impacts of interlayer dielectric material, wire material, and 3D integration on the power consumption,
power supply noise, and number of metal layers required for routing are investigated.
...
\changed{
The system is treated as a homogeneous logic block.
This assumption is commonly used with stochastic wiring models to enable rapid estimation of the 
wire parameters without a priori knowledge about the design specifics, at the cost of some 
...
In order to investigate the ultimate limits of 3D integration, we consider a scenario in which logic gates and blocks can be placed on
...
at advanced process nodes. \changed{
Highly-stacked high performance 3DICs were shown to require large numbers of power delivery TSVs,
...
increased power density of the 3D cores. The use of highly-thinned dice and low-k dielectrics were shown to
be an effective methods for reducing the power consumption and power TSV requirements of high performance 3DICs.
The results suggest that 3D systems should exhibit greater energy efficiency
